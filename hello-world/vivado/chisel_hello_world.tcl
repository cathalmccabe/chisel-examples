...
################################################################
# This is a generated script based on design: chisel_hello_world
#
...
# source chisel_hello_world_script.tcl
...
set design_name chisel_hello_world
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set io_led_0 [ create_bd_port -dir O io_led_0 ]

  # Create instance: Hello_0, and set properties
  set block_name Hello
  set block_cell_name Hello_0
  if { [catch {set Hello_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net Hello_0_io_led [get_bd_ports io_led_0] [get_bd_pins Hello_0/io_led] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Hello_0/clock] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins Hello_0/reset] [get_bd_pins processing_system7_0/GPIO_O]
