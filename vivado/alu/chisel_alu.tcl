...
################################################################
# This is a generated script based on design: chisel_alu
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AluTop_0, and set properties
  set block_name AluTop
  set block_cell_name AluTop_0
  if { [catch {set AluTop_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net AluTop_0_io_led [get_bd_ports led] [get_bd_pins AluTop_0/io_led] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AluTop_0/clock] [get_bd_pins processing_system7_0/FCLK_CLK0]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins AluTop_0/reset] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins AluTop_0/io_sw] [get_bd_pins xlslice_1/Dout]
